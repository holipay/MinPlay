...
| 2026-06 | HLS live freeze | MF source reader caches EOF when bytestream returns 0 bytes; EOF flag is immutable. Stop()+StartReading() cannot clear it. | HlsByteStream Read/BeginRead wait 2s for data; EOF handler seeks to clear state |
