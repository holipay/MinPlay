...
cl %OPTFLAGS% /W4 /utf-8 /EHsc ^
    ...
    src\demux\ts_packet_parser.cpp src\demux\pes_assembler.cpp src\demux\program_manager.cpp src\demux\ts_demuxer.cpp src\demux\ts_byte_stream.cpp src\demux\hls_media_source.cpp ^
